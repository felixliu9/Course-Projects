...
TableEntry::TableEntry(const char* val)
  : tag{EntryType::String}, data_string{val} {}
TableEntry::TableEntry(const string& val)
  : tag{EntryType::String}, data_string{val} {}
TableEntry::TableEntry(string&& val)
  : tag{EntryType::String}, data_string{move(val)} {}
TableEntry::TableEntry(double val)
  : tag{EntryType::Double}, data_double{val} {}
TableEntry::TableEntry(int val)
  : tag{EntryType::Int}, data_int{val} {}
TableEntry::TableEntry(bool val)
  : tag{EntryType::Bool}, data_bool{val} {}
